...
const TableContentSubVariacoes = () => {
  const router = useRouter()

  const parentId = router.query['parentVariacoes'] as string
                      ...
                      <Portal>
                        <PopoverContent bg="transparent">
                          <PopoverBody
                            ...
                            p="0"
                          >
                            <NextLink href={`/admin/variacoes/editar/${id}`}>
...
export default TableContentSubVariacoes
